data atussum_2014;
length TUCASEID $14;
infile 'c:\atussum_2014.dat' lrecl=8192 dlm=',' missover dsd firstobs=2;
input
TUCASEID
TUFINLWGT
TRYHHCHILD
...
label t140104 = "Security procedures rel. to religious and spiritual activities";
...
;
run;
proc contents data=atussum_2014; run;
